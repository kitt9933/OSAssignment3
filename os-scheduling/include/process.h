...
private:
    ...
    State lastState;            //previous state of process
    ...
    uint64_t state_start;       // start time of the process's current state
...
public:
    ...
    void setLastState(State state, uint64_t current_time);
